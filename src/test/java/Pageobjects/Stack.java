package Pageobjects;
	...
	public class Stack extends LoginTest {
	 ...
	 @FindBy (xpath="//a[@data-toggle='dropdown']") public WebElement Dropdown;
		...
		@FindBy (xpath="//a[contains(text(),'Practice Questions')]") WebElement PracticeQue;

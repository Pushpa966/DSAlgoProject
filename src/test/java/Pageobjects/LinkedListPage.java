...
public class LinkedListPage  extends LoginTest {
	
	//to Select Dropdown
     @FindBy (xpath="//a[@data-toggle='dropdown']") public WebElement Dropdown;
	//To select Linkedlist at Datastructure Dropdown
	@FindBy (xpath="//a[contains(text(),'Linked List')]") public WebElement LinkedList;
	
	//Linked lists introduction
	@FindBy (xpath="//a[contains(text(),'Introduction')]") WebElement LinkedlistIntroduction;
	...
	@FindBy (xpath="//a[contains(text(),'Creating Linked LIst')]") WebElement Createlinkedlists;
	
	// Types of Linked List
	@FindBy (xpath="//a[contains(text(),'Types of Linked List')]") WebElement TypesofLinkedList;
 
	//Implement Linked List in Python
	@FindBy (xpath="//a[contains(text(),'Implement Linked List in Python')]") WebElement ImplementLinkedListinPython;

	...
	public class Arrays  extends LoginTest {
		
		//to Select Dropdown
	 @FindBy (xpath="//a[@data-toggle='dropdown']") public WebElement Dropdown;
		//To select ARray at Datastructure Dropdown
		@FindBy (xpath="//a[contains(text(),'Arrays')]") public WebElement Arrays;
		
		//Arrays in Python
		@FindBy (xpath="//a[contains(text(),'Arrays in Python')]") WebElement ArraysPython;
		@FindBy (xpath="//a[contains(text(),'Try here>>>')]") WebElement TryHereButton;
		@FindBy (xpath="//form[@id='answer_form']/div/div/div/textarea") WebElement AnswerForm;
		@FindBy (xpath="//form[@id='answer_form']/button") WebElement RunButton;
		
		//Arrays using list
		@FindBy (xpath="//a[contains(text(),'Arrays Using List')]") WebElement ArraysList;
		
		//Basic Operations in Lists
		@FindBy (xpath="//a[contains(text(),'Basic Operations in Lists')]") WebElement BasicOInList;
	 //Applications of Array
		@FindBy (xpath="//a[contains(text(),'Applications of Array')]") WebElement AppliArray;
